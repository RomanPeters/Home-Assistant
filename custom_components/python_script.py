"""
Customized component to allow running Python scripts.

For more details about the original component, please refer to the documentation at
...
def execute(hass, filename, source, data=None):
    ...
    builtins['subprocess'] = subprocess  # custom addition
    restricted_globals = {
